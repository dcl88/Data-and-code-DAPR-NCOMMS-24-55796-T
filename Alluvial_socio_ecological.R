...
install.packages(c("dplyr", "sp", "sf", "rgdal", "tmap", "stars", "raster", "rasterVis", "scales", "tidyverse", "ggspatial", "ggplot2", "ggmap", "ggpubr", "ggpattern", "viridis", "biscale", "cowplot", "webr","moonBook", "ggalluvial"))
...
wd <- "C:/Users/cruzlopd/OneDrive - Queensland University of Technology/Sustainable intensification/Project_IntercroppingReview/Nature Communications/Code Ocean/Maps_and_alluvial_socio_ecological"
