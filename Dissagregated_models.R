...
library(gridExtra)
  ...
  workingdir<-"C:/Users/cruzlopd/Dropbox/Code/3.Final_data_code/Disaggregated_models/Yieldeqcumul"
  setwd(workingdir)
  getwd()
...
# Add only the visible y and x axes
  ...
  ###Load data###
  ##set working directory
  workingdir<-"C:/Users/cruzlopd/Dropbox/Code/3.Final_data_code/Disaggregated_models/Primary_production"
  setwd(workingdir)
  getwd()
  ...
  ###Load data###
  ##set working directory
  workingdir<-"C:/Users/cruzlopd/Dropbox/Code/3.Final_data_code/Disaggregated_models/Soil_organic_carbon"
  setwd(workingdir)
  getwd()
