...
- R 4.3.1 or later
- R packages: `DescTools`, `lme4`,`ggpubr`,`performance`,`ggplot2`,`gridExtra`,`scales`,`ggalluvial`,`sp`, `sf`,`tmap`,`stars`,`raster`,`cowplot`,`ggspatial`
- Operating System: Linux, macOS, or Windows 10/11
- Code Ocean (https://codeocean.com/): RStudio Cloud Workstation (RStudio 2024.04.2-764) `DescTools`, `lme4`,`ggpubr`,`performance`,`ggplot2`,`gridExtra`,`scales`,`ggalluvial`,`sp`, `sf`,`tmap`,`stars`,`raster`,,`cowplot`,`ggspatial`
...
```
install.packages(c("DescTools", "lme4", "ggpubr", "performance", "ggplot2", "gridExtra", "scales","grid"))
```
